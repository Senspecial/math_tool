...
class BaseTool(ABC):
    ...
    # Set to True for tools that end the episode when called (e.g. answer
    # submission tools).  ToolEnv.step() returns done=True as soon as any
    # terminal tool has been executed in the current step.
    terminal: bool = False
